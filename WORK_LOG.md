...
## 현재 게임 스펙 스냅샷
> 갱신: 2026-03-11 (세션50 ASCII 아트 시스템 + 몬스터 50종 반영)
...
| 1 | 고블린 독침수 | 40 | 5 | 독2 |
| 1 | 고블린 대장 | 72 | 9 | 엘리트 |
| 1 | 고블린 전투광 | 68 | 10 | 엘리트, 격노, 도둑4 |
| 1 | 고블린 마술사 | 60 | 8 | 엘리트, 약화1, 빙결1 |
| 1 | 고블린 킹 | 94 | 11 | 보스 |
| 2 | 해골 병사 | 59 | 7 | - |
| 2 | 뱀파이어 | 72 | 9 | - |
| 2 | 구울 | 63 | 8 | 재생4 |
...
| 2 | 독안개 유령 | 55 | 7 | 독3 |
| 2 | 망령 기사 | 91 | 10 | 엘리트 |
| 2 | 흡혈 백작 | 85 | 11 | 엘리트, 재생6, 격노 |
| 2 | 저주술사 | 78 | 9 | 엘리트, 약화2, 침식1 |
| 2 | 리치 | 124 | 12 | 보스 |
| 3 | 골렘 | 72 | 8 | 빙결1 |
| 3 | 마녀 | 85 | 10 | 빙결2 |
| 3 | 가고일 | 88 | 7 | 격노2 |
| 3 | 원소술사 | 75 | 9 | 빙결1, 화상1 |
| 3 | 마법 인형 | 80 | 8 | 방어4, 약화1 |
| 3 | 독염 술사 | 76 | 9 | 독2, 화상1 |
| 3 | 불꽃 정령 | 104 | 11 | 엘리트, 빙결1 |
| 3 | 수정 골렘 | 120 | 10 | 엘리트, 방어5, 격노2 |
| 3 | 마력 폭주자 | 95 | 12 | 엘리트, 격노, 빙결2, 화상1 |
| 3 | 대마법사 | 143 | 13 | 보스, 빙결2, 분열 |
| 4 | 그림자 포식자 | 78 | 9 | - |
| 4 | 심연의 눈 | 98 | 11 | 침식1 |
| 4 | 심연거미 | 85 | 10 | 빙결1, 골드도둑6 |
| 4 | 공허흡수자 | 92 | 11 | 침식1, 격노2 |
| 4 | 심연 독충 | 88 | 10 | 독4 |
| 4 | 공허 감시자 | 82 | 9 | 방어3, 침식1 |
| 4 | 공허의 사도 | 124 | 12 | 엘리트, 침식2 |
| 4 | 심연 포식왕 | 135 | 13 | 엘리트, 독3, 도둑8, 격노 |
| 4 | 공허 직조자 | 118 | 11 | 엘리트, 약화3, 빙결2 |
| 4 | 심연의 군주 | 176 | 15 | 보스, 침식2 |
| 5 | 드래곤 알지기 | 117 | 12 | - |
| 5 | 드래곤 새끼 | 143 | 14 | 화상1 |
| 5 | 용암도마뱀 | 130 | 13 | 격노3, 화상1 |
| 5 | 드래곤 사제 | 125 | 11 | 재생10 |
| 5 | 용암 독사 | 135 | 13 | 독5, 화상1 |
| 5 | 드래곤 수호병 | 148 | 12 | 방어6 |
| 5 | 드래곤 근위병 | 182 | 16 | 엘리트, 화상1 |
| 5 | 화염 폭군 | 195 | 17 | 엘리트, 화상2, 격노, 분노2 |
| 5 | 고대 용사제 | 170 | 14 | 엘리트, 재생12, 방어4, 약화2 |
| 5 | 드래곤 로드 | 260 | 20 | 보스, 화상2 |

### 몬스터 특수능력
| 능력 | 설명 |
|------|------|
| shield(방어) | 플레이어 공격 데미지 감소 |
| enrage(격노) | HP 50% 이하 시 ATK x1.5 폭주 |
| mPoison(독) | 매턴 플레이어 HP 감소 (회피 무관) |
| weaken(약화) | 플레이어 배율 감소 |
| steal(골드도둑) | 골드 강탈 |
| rage(분노) | ATK 누적 증가 |
| regen(재생) | 매턴 HP 회복 |
| freeze(빙결) | 카드 빙결 |
| erode(침식) | 카드 등급 감소 |
| burn(화상) | 화상 카드 주입 |
| split(분열) | HP 절반 시 분열체 소환 |

### 지도 시스템
| 항목 | 값 |
|------|-----|
| 맵 구조 | 8행 (시작→전투/캠프/상점/이벤트×5→보스→상점) |
| 행당 노드 | 2~3개 (보스/마지막 상점은 1개) |
...
| 항목 | 값 |
|------|-----|
| 배경 | ASCII 아트 (ascii-art.js) — 9종 + 애니메이션 |
| 몬스터 | ASCII 아트 50종 + 이모지 폴백 |
| 래퍼 | GameWrap 공용 컴포넌트 (3레이어: ASCII bg → gradient → content) |
