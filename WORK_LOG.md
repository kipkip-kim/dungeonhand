...
### Part A: 코드 품질 수정
- [x] 1. getFloorFilter() dead code 삭제
- [x] 2. 캠프힐/화상 매직넘버 상수 추출 (CAMP_HEAL, CAMP_REST_HEAL, BURN_DAMAGE)
- [x] 3. SUIT_ORDER 상수 추출
- [x] 4. 미사용/이중 import 정리
- [x] 5. dead comment 제거

### Part B: 밸런스 수정 5건
- [x] 심연의 군주 이모지 🌀 → 👿 (중복 해소)
- [x] 가시 갑옷 반사 2 → 3 (T1 최약 유물 상향)
- [x] 도박사의 주사위 lose -0.5 → -0.3 (기대값 개선)
- [x] 감정사의 눈 등급 기준 4 → 5 (T2 과도한 스케일링 억제)
- [x] 급소숙련 코스트 4 → 3 (critMastery 효율 개선)

### Part C: WORK_LOG 핸드오프 구조
